...
func TestHasCapability(t *testing.T) {
	var capabilitiesList = []TestCapabilities{
		...
		{[]string{MariaDbFlavor}, GaleraCluster, "10.0.0", true},
		{[]string{MariaDbFlavor}, GaleraCluster, "10.11.0", true},
		{[]string{MariaDbFlavor}, GaleraCluster, "5.5.0", false},
		{[]string{MySQLFlavor, PerconaServerFlavor}, GaleraCluster, "10.11.0", false},
